...
Design-based inference is a coherent and internally consistent framework for estimating quantities and quantifying uncertainty.  
...
There are ways to handle all of these issues (mostly through the use of survey weights), but it is important to realize that using a modern survey "as if" it was a simple random sample might lead to poor performance and incorrect inferences.  
